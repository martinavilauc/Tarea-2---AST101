...
- **(SEMI-HECHO)** Desactivar wireframes por ajustes y por defecto en modo movil.
- En modo movil: al seleccionar un cuerpo quitar el indice automaticamente.
- En modo movil: añadir boton o menu desplegable de info del cuerpo en lugar de mostrarlo tapando la pantalla.
