...
- **(Semi-Arreglado, el zoom se reinicia)** Al quitar o poner orbita (y en general al cambiar settings) la camara se reinicia.
- Al hacer click en el wireframe del planeta ya seleccionado se reinicia la camara.
